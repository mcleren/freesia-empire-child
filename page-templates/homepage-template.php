...
<div id="primary">
	...
	<div id="main">using template/homepage-template.php
	svg start
	<!--object id="sp" type="image/svg+xml" data="http://sandbox.lenoxhomeloans.com/wp-content/themes/freesia-empire-child/images/Search-Icon.svg">SitePoint</object-->
	svg end
				...
				<div class="one-column">
					...
					<article class="format-audio">
						<div class="blog-img freesia-animation fadeInDown" data-wow-delay="0.3s">
							<img width="768" height="580" src="http://demo.themefreesia.com/freesia-empire/wp-content/uploads/sites/6/2016/01/post-image-1.jpg" class="attachment-post-thumbnails size-post-thumbnails wp-post-image" alt="Think something new" title="Think something new" srcset="http://demo.themefreesia.com/freesia-empire/wp-content/uploads/sites/6/2016/01/post-image-1.jpg 768w, http://demo.themefreesia.com/freesia-empire/wp-content/uploads/sites/6/2016/01/post-image-1-300x227.jpg 300w" sizes="(max-width: 768px) 100vw, 768px" />
							<div class="blog-overlay">
								<a href="#"><span class="ico-link"></span></a>
							</div><!-- end.blog-overlay -->
						</div><!-- end.blog-img -->
						<div class="blog-content freesia-animation fadeInUp" data-wow-delay="0.3s">
							<header class="entry-header">
								<h3 class="entry-title"><a rel="bookmark" href="http://demo.themefreesia.com/freesia-empire/2016/01/20/think-something-new/">Think something new </a></h3>
								<div class="entry-meta clearfix">
									<span class="entry-format"><a href="http://demo.themefreesia.com/freesia-empire/type/audio/">Audio</a></span> 
									<span class="author vcard"><a href="http://demo.themefreesia.com/freesia-empire/author/demo_themefreesia/" title="demo_themefreesia">demo_themefreesia</a></span>
									<span class="posted-on"><a title="2:46 am" href="http://demo.themefreesia.com/freesia-empire/2016/01/20/think-something-new/">January 20, 2016</a></span>
								</div>  <!-- end .entry-meta -->
							</header><!-- end.entry-header -->
							<div class="entry-content"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed mattis ut ligula quis ultricies.Lorem ipsum dolor sit amet, </p>
								<a class="more-link" title="Think something new" href="http://demo.themefreesia.com/freesia-empire/2016/01/20/think-something-new/">Read More										</a>
							</div> <!-- end .entry-content -->
						</div> <!-- end .blog-content -->
					</article><? */?>
				</div> <!-- end .two-column -->
